...
<body>
 ...
 <div class="sticky-top bg-dark d-flex align-content-center">
	<a href="/" class="active nav-link text-white"><h1><i>Cognizant Bank</i></h1></a>
...
<div class="container" style="object-fit: cover;">
	<h4 class="text-centre">Welcome to Cognizant Bank</h4>
...
<div class="container text-white" style="object-fit: cover;">
	<div class="jumbotron bg-cover"
		style="background-image: url(images/feeedback.png)">
		<h1 class="display-4">Presenting the all new Cognizant Banking</h1>
...
<div class="component text-white bg-secondary text-center" style="background-color='#e6ffff';">
	<div class="component container">
		...
		<h4>About Us</h4>
		<div class="container">
			<p class="row">Cognizant Bank Limited is an Indian private sector
			...
			<p class="row">Cognizant Bank was formed in September of 2000,
				...
				care and excellence in mind. Today Cognizant Bank is going strong,
