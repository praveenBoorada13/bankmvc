...
<body class="doodle">
	...
	<center>
		<h1><i>Welcome to The Cognizant Bank</i></h1>
	</center>
	...
	<div class="row container justify-content-around">
		...
		<div class="col-xs-12 col-sm-6 col-md-4">
			<div style="margin: 9em 10em 0em 0em;">
		...
		<div class="col-xs-12 col-sm-6 col-md-4">
			<div style="margin: 9em 120em 14em 3em;">
				<div class="card bg-dark text-white" style="width: 500px; background-color: #f3d8d8">
					<img alt="" class="card-img-top" src="/Images/trans1.jpg" style="height:200px">
					<div class="card-body">
