...
<nav
	...
	<div class="container-ls row">
		...
		<div class="col-xs-14 col-sm-6 col-md-4">
			<div style="margin: 2em 0em 0em 15em;">
				<div class="card bg-dark text-white" style="width:350px">
					<img alt="" src="images/create-customer.png"  style="height:250px">
					<div class="card-body">
		...
		<div class="col-xs-14 col-sm-6 col-md-4">
			<div style="margin: 2em 0em 0em 20em;">
				<div class="card bg-dark text-white" style="width:350px">
					<img alt="" src="images/createaccount.png" style="height:250px">
					<div class="card-body">
  ...
  <div class="col-xs-14 col-sm-6 col-md-4">
			<div style="margin: 2em 0em 0em 15em;">
				<div class="card bg-dark text-white" style="width:350px">
					<img alt="" src="images/delete.jpg"  style="height:250px">
					<div class="card-body">
	...
	<div class="col-xs-14 col-sm-6 col-md-4">
			<div style="margin: 2em 0em 0em 20em;">
				<div class="card bg-dark text-white" style="width:350px">
					<img alt="" src="images/delacc.png"  style="height:250px">
					<div class="card-body">
	...
	<div class="container-ls row">
		...
		<div class="col-xs-12 col-sm-6 col-md-4">
			<div style="margin: 2em 0em 0em 15em;">
				<div class="card bg-dark text-white" style="width:350px">
					<img alt="" src="images/getAllCustomers.png" style="height:250px">
					<div class="card-body">
		...
		<div class="col-xs-12 col-sm-6 col-md-4">
			<div style="margin: 2em 0em 0em 20em;">
				<div class="card bg-dark text-white" style="width:350px">
					<img alt="" src="images/deposit.png" style="height:250px">
						<h4 class="card-title">Deposit Amount</h4>
						<form action="/deposit.jpg" class="form-group container" method="post">
	...
	<div class="container-ls row">
        <div class="col-xs-12 col-sm-6 col-md-4">
			<div style="margin: 2em 0em 0em 15em;">
				<div class="card bg-dark text-white" style="width:350px">
					<img alt="" src="images/trans1.jpg" style="height:250px">
					<div class="card-body">
